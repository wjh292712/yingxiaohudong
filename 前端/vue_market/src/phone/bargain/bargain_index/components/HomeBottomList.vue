...
<div class="main">
    ...
    <mt-tab-container v-model="selected" swipeable>  
      ...
      <mt-tab-container-item id="1" v-if="list.length!=0">  
        <ul>
        <li v-for="(item,key) in list" class="mt1 border-bottom" @click="bargain(item.id)" :key="key">
 ...
 <p style="text-align:center;margin-top:.4rem">{{emtry_text}}</p>
      ...
      <mt-tab-container-item id="2" v-if="participatelists!=null">  
        <ul>
        <li v-for="(item,key) in participatelists"  class="mt2 border-bottom" @click="bargainDesc(item.id)" :key="key">
         <span class="left-img" slot="icon">
