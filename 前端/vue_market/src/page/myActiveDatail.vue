<template>
    ...
    <!--<div class="ddd" style="text-align: center">-->
      <!--<el-table-->
        ...
        <!--<el-table-column-->
          <!--prop="takeNumber"-->
          <!--label="参与">-->
          <!--&lt;!&ndash;:filters="[{ text: '家', value: '家' }, { text: '公司', value: '公司' }]"&ndash;&gt;-->
          <!--&lt;!&ndash;:filter-method="filterTag"&ndash;&gt;-->
          <!--&lt;!&ndash;filter-placement="bottom-end">&ndash;&gt;-->
          <!--&lt;!&ndash;<template slot-scope="scope">&ndash;&gt;-->
          <!--&lt;!&ndash;<el-tag&ndash;&gt;-->
          <!--&lt;!&ndash;:type="scope.row.tag === '家' ? 'primary' : 'success'"&ndash;&gt;-->
          <!--&lt;!&ndash;disable-transitions>{{scope.row.tag}}</el-tag>&ndash;&gt;-->
  ...
  <!--<span class="el-dropdown-link">-->
    <!--更多-->
    <!--&lt;!&ndash;<i class="el-icon-caret-bottom el-icon&#45;&#45;right"></i>&ndash;&gt;-->
  <!--</span>-->
          ...
          <!--&gt;-->
        <!--</el-table-column>-->
        <!--&lt;!&ndash;<el-table-column type="selection"  :reserve-selection="true" width="55"> </el-table-column>&ndash;&gt;-->
      <!--</el-table>-->
      <!--<div class="block">-->
        <!--<el-pagination-->
          <!--background-->
