        ...
        <div class="phone_body">
          ...
          <div class="nine_blog">
            <div class="title_image">
              <span class="active_pep">已有<i>{{count}}</i>人参与挑战</span>
              <span class="dati"><img src="../../static/active/dati.png" alt=""></span>
                ...
                .active_phoneCon {
                  ...
                  .phone_body {
                    ...
                    .nine_blog {
                      ...
                      margin: 0 auto;
                      .title_image {
                        background: url("../../static/active/home.png") no-repeat center;
                        height: 100%;
                        width: 100%;
                        overflow: hidden;
                        background-size: 100%;
