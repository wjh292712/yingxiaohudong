...
<script>
  ...
  //import BottomView from "../new_page/BuySuccess/components/bottom";
  import BottomView from "../version/BuySuccess/components/bottom";
  import AlertMessage from "@/components/PcAlertMessage";
  import pub from "static/public.js";
  import TielView from "../new_page/components/title";
          ...
          $.ajax({
            ...
            success: function (data) {
              ...
              if (data.data == "SUCCESS") {
                clearInterval(this.timer)
                thi_s.$router.push("/indexVers/verBuySuccess")
              }
            }
          });
        }, 1000);
